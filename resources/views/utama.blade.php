                    ...
                    @foreach ($produk as $p)
                        <div class="col-lg-4 col-md-6 portfolio-item {{ $p->nama }}">
                            <div class="portfolio-wrap">
                                <img src="/image/{{ $p->gambar }}" class="img-fluid" alt="" width="400px"
                                    height="600px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body clearfix">
                                        <div class="card" style="width: 18rem;">
                                            <img src="/image/{{ $p->gambar }}" class="card-img-top"
                                                alt="{{ $p->nama }}">
                                            <div class="card-body">
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 text-lg-left text-center">
                    <div class="copyright">
                        &copy; Copyright <strong>Terate Store-22</strong>. All Rights Reserved
                    </div>
                    <div class="credits">
